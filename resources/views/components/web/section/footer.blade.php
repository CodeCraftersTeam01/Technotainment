<footer id="footer" class="bg-[#071225] border-t border-[#5fa8d3]/[0.07] px-10">
    <div
        ...
        <div class="lg:w-1/3 flex flex-col">
            <div class="flex justify-center space-x-4 lg:justify-start">
                ...
                <span
                    class="self-center text-xl md:text-2xl font-bold text-white tracking-wide">{{ $event ? $event->event_name . ' ' . ($event->event_year ?? date('Y')) : 'No Event' }}</span>
            </div>
    ...
    <div class="py-6 md:py-8 text-sm text-center text-gray-400 border-t border-gray-800">
        <p class="px-4">© {{ $event ? Str::upper($event->event_name) . ' ' . ($event->event_year ?? date('Y')) . ' | ' : '' }}UKMFT -
