    ...
    <script>
        ...
        document.getElementById('submit-form').addEventListener('click', function(e) {
            ...
            for (let i = 1; i <= memberCount; i++) {
                const isOptional = (slug === 'Ia1Dh6sZdQ' && i === 5);
                ...
                if (!isOptional) {
                    ...
                    if (!memberIdentity.files || memberIdentity.files.length === 0) {
                        hasErrors = true;
                        const li = document.createElement('li');
                    ...
                    // Jika optional dan nama terisi, maka identity juga wajib
                    if (memberName.value.trim()) {
                        memberName.classList.remove('border-red-500');
                        ...
                        if (!memberIdentity.files || memberIdentity.files.length === 0) {
                            ...
                            errorList.appendChild(li);
                            memberIdentity.classList.add('border-red-500');
                        } else {
                            memberIdentity.parentElement.classList.remove('border-red-500');
                        }
                    } else if (memberIdentity || memberIdentity.files.length !== 0) {
                        memberIdentity.parentElement.classList.remove('border-red-500');
                        ...
                        if (memberName.value.trim() === "") {
                            ...
                            li.textContent = `Nama Anggota ${i} harus diisi`;
                            errorList.appendChild(li);
                            memberName.parentElement.classList.add('border-red-500');
                        } else {
                            memberName.classList.remove('border-red-500');
                        }
                    } else {
                        // Jika tidak diisi, hapus error styling (jaga-jaga)
                        memberName.classList.remove('border-red-500');
                        memberIdentity.parentElement.classList.remove('border-red-500');
                    }
                }
