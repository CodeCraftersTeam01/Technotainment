    ...
    <div class="w-full h-full bg-white shadow-lg rounded-3xl p-5">
        ...
        <form id="updateCompetitionForm" action="{{ route('competitions.update', $competition->competition_id) }}"
            ...
            <x-form.select label="Competition View Template" id="competition_view_template" name="competition_view_template">
                <option value="mobilelegend" {{ old('competition_view_template', $competition->competition_view_template) == 'mobilelegend' ? 'selected' : '' }}>Mobile Legend (6 Members)</option>
                <option value="pes" {{ old('competition_view_template', $competition->competition_view_template) == 'pes' ? 'selected' : '' }}>PES/E-Football (1 Member)</option>
                <option value="uiux" {{ old('competition_view_template', $competition->competition_view_template) == 'uiux' ? 'selected' : '' }}>UI/UX (3 Members + Abstract)</option>
                <option value="webdesign" {{ old('competition_view_template', $competition->competition_view_template) == 'webdesign' ? 'selected' : '' }}>Web Design (3 Members)</option>
            </x-form.select>
