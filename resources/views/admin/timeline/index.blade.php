<x-admin.layout header="Timeline">
            ...
            <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                @forelse($competitions as $competition)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <img class="h-28 w-28 md:w-fit object-cover md:object-contain" src="{{ Storage::url($competition->competition_logo) }}"
                                alt="logo">
                        </td>
                        <td class="px-6 py-4">{{ $competition->competition_name }}</td>
                        <td class="px-6 py-4">{{ $competition->competition_type }}</td>
                        <td class="px-6 py-4">
                            <span
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-2">
                                <x-button.action icon="components.icons.info"
                                    href="{{ route('timelines.show', $competition->competition_id) }}"
